...
class ResultsScreen extends FlxSubState
{
    ...
    public var comboText:FlxTypeText;
	...
	override function create()
	{
		...
		PlayState.strumLineNotes.forEachAlive(function(sp:FlxSprite){
        FlxTween.tween(sp,{alpha :0},0.5,{ease: FlxEase.expoInOut});
		});
        FlxTween.tween(PlayState.instance.iconP1,{alpha :0},0.5,{ease: FlxEase.expoInOut});
        FlxTween.tween(PlayState.instance.iconP2,{alpha :0},0.5,{ease: FlxEase.expoInOut});
        FlxTween.tween(PlayState.instance.healthBar,{alpha :0},0.5,{ease: FlxEase.expoInOut});
        FlxTween.tween(PlayState.instance.healthBarBG,{alpha :0},0.5,{ease: FlxEase.expoInOut});
