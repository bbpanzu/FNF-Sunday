	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			default :
				...
				animation.addByPrefix('idle', character + ' idle', 24, false);
				animation.addByPrefix('singUP', character + ' up', 24, false);
				animation.addByPrefix('singDOWN', character + ' down', 24, false);
				animation.addByPrefix('singLEFT', character + ' left', 24, false);
				animation.addByPrefix('singRIGHT', character + ' right', 24, false);
				addOffset('idle');
				addOffset("singUP");
				addOffset("singRIGHT");
				addOffset("singLEFT");
